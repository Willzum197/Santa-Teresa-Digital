...
# ============================================
# ESTILOS PRINCIPALES - CORREGIDO (Letras visibles)
# ============================================
st.markdown("""
<style>
...
/* Contenido principal - fondo MUY OSCURO para contraste */
.main > div {
...
/* TODO EL TEXTO EN BLANCO PURO con sombra */
.main, 
.main p, 
.main span, 
.main div, 
...
/* Texto en expanders - fondo oscuro */
...
# ============================================
# ENCABEZADO SIMPLE (CON FONDO OSCURO)
# ============================================
st.markdown("""
<div style="text-align: center; margin-bottom: 20px;">
    <div style="background: linear-gradient(135deg, #1a1a2e, #16213e);
        ...
        <p style="color: white; text-shadow: 2px 2px 4px black; font-size: 1.2em; margin-top: 10px;">Informacion, Cultura y Fe de nuestro pueblo</p>
    </div>
</div>
""", unsafe_allow_html=True)
